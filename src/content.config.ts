...
// article-numbering invariant in DESIGN_SYSTEM.md §19.9 intact. The site's
// own prose (about text, experience, interests, …) is not a collection: it
// lives in src/copy.ts.
//
